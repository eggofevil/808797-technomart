...
* Студент: [Алексей Гурин](https://up.htmlacademy.ru/htmlcss/22/user/808797).
* Наставник: * Наставник: [Без наставника].
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/808797-technomart) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
